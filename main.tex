...
\LARGE
\only<1>{1982}\only<2>{1986}\only<3>{1987}\only<4>{1992}\only<5>{2000}\only<6>{2002}\only<7>{2005}\only<8>{2012}\only<9>{2015}\only<10>{2016}\only<11>{2018}\only<12>{2018}\only<13>{\mbox{ }}
